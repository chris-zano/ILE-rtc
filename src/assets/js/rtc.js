/**
 * @author Pendem Vamsi <aceaventure@gmail.com>
...
window.addEventListener('load', async () => {
    ...
    if (onboardingURL.test(window.location.href)) {
       ...
       sessionStorage.setItem('chapter-info', JSON.stringify(courseChapter))
        ...
        const userInfo =sessionStorage.getItem('user-info') ? JSON.parse(localStorage.getItem('user-info')) : null;
        const chapterInfo =sessionStorage.getItem('chapter-info') ? JSON.parse(localStorage.getItem('chapter-info')) : null;
